...
extern "C" {
    ...
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_init(JNIEnv* env, jobject obj, jobject activity,
            jint time, jfloat accelRange, jfloat xDpi, jfloat yDpi);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_create(JNIEnv* env,jobject obj);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_start(JNIEnv* env,jobject obj);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_change(JNIEnv* env,jobject obj, jobject surface);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_resume(JNIEnv* env, jobject obj, jint time);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_result(JNIEnv* env, jobject obj, jint req,
            jint res, jobject intent);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_pause(JNIEnv* env, jobject obj, jboolean finishing,
            jboolean lockScreen);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_destroy(JNIEnv* env, jobject obj);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_stop(JNIEnv* env,jobject obj);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_free(JNIEnv* env, jobject obj);

    JNIEXPORT jshort Java_com_studio_artaban_crystalball_EngLibrary_loadTexture(JNIEnv* env, jobject obj, jshort id,
            jshort width, jshort height, jbyteArray data, jboolean grayscale);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_loadOgg(JNIEnv* env, jobject obj, jshort id,
            jbyteArray data, jboolean queued);
    JNIEXPORT jboolean Java_com_studio_artaban_crystalball_EngLibrary_loadFile(JNIEnv* env, jobject obj, jstring file,
            jstring content);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_loadCamera(JNIEnv* env, jobject obj,
            jbyteArray data);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_loadMic(JNIEnv* env, jobject obj, jint len,
            jshortArray data);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_loadSocial(JNIEnv* env,jobject obj, jshort id,
            jshort request, jshort result, jshort width, jshort height, jbyteArray data);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_loadStore(JNIEnv* env,jobject obj, jshort result);

    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_touch(JNIEnv* env, jobject obj, jint id,
            jshort type, jfloat x, jfloat y);
    JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_accelerometer(JNIEnv* env, jobject obj,
...
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_init(JNIEnv* env, jobject obj, jobject activity,
    ...
    init(platformData);
    platformInit(static_cast<long>(time), &platformData);
}
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_create(JNIEnv* env,jobject obj) {
    platformCreate();
}
...
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_resume(JNIEnv* env, jobject obj, jint time) {
    platformResume(static_cast<long>(time));
}
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_result(JNIEnv* env, jobject obj, jint req,
        jint res, jobject intent) {
...
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_loadCamera(JNIEnv* env, jobject obj, jbyteArray data) {
...
void Java_com_studio_artaban_crystalball_EngLibrary_loadStore(JNIEnv* env,jobject obj, jshort result) {
...
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_touch(JNIEnv* env, jobject obj, jint id, jshort type,
        jfloat x, jfloat y) {
    platformTouch(static_cast<unsigned int>(id), static_cast<unsigned char>(type), static_cast<short>(x),
            static_cast<short>(y));
}
JNIEXPORT void Java_com_studio_artaban_crystalball_EngLibrary_accelerometer(JNIEnv* env, jobject obj, jfloat xRate,
