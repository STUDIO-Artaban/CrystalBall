...
public class EngLibrary {
    ...
    public static native void init(EngActivity activity, int delay, float accelRange, float xDpi, float yDpi); // onCreate
    public static native void create(); // surfaceCreated
    public static native void start(); // onStart
    public static native void change(Surface surface); // surfaceChanged
    public static native void resume(int delay); // onResume
